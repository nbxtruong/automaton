...
public class Automata {
	...
	public boolean verifyAutomata() {
		try {
			observable = new ObservableAutomaton<String>(
					convertTranitionsListToArray(tranitions));
	...
	public static Transition<String>[] convertTranitionsListToArray(
			List<Transition<String>> list) {
		...
		if (this.verifyAutomata()) {
			observable.addObserver(new Observer() {
				...
				public void update(Observable arg0, Object arg1) {
					// ((Transition<String>)
					// arg1).label().setColor(Color.green);
					@SuppressWarnings("unchecked")
